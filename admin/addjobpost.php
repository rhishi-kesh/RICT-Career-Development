<?php
   ...
   if(isset($_POST['submit'])){
      ...
      $sql = "INSERT INTO `jobposts`(`post_title`, `company_title`, `company_logo`, `company_details`, `job_position`) VALUES ('$jobtitle','$company_name','$file_name','$job_description', '$job_position')";
                           ...
                           ?>
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <input type="file" id="company_logo" class="form-control" required name="company_logo"/>
                                </div>
                                <div class="form-outline mb-4">
                                    <label class="form-label" for="job_position">Job Position</label>
                                    <input type="text" id="job_position" class="form-control" name="job_position" required/>
                                </div>
                                <div class="form-outline mb-4">
                                    <label class="form-label" for="jobpost_title">Job Post Title</label>
                                    <input type="text" id="jobpost_title" class="form-control" required name="jobpost_title"/>
                                </div>
                                <div class="form-outline mb-4">
                                    <label class="form-label" for="job_description">Job Description</label>
                                    <textarea id="job_description" class="form-control" required name="job_description"></textarea>
                                </div>
                                <button type="submit" class="btn btn-primary mb-4" name="submit">Add Post</button>
